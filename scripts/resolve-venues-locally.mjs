...
for (const [venueId, branch] of Object.entries(state.venues)) {
  ...
  results.push({ venueId, venue:branch.venue, eventIds:branch.eventIds, locationEvidence, status:accepted?'candidate_matched':(place||exactCandidates.length)?'needs_review':'not_found', alias:alias||null,
