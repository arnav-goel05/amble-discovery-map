...
Install either `deploy/whats-here-weekly.cron` or the systemd service/timer after replacing the example working directory and checking the Node/npm paths. Both use free single-host scheduling; do not install both.
